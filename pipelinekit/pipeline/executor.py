...
from pipelinekit.core.exceptions import PipelineException
from pipelinekit.destinations import FileSink
...
class PipelineExecutor:
    ...
    def _create_sink(self, config: dict) -> Destination:
        ...
        if isinstance(sink_class_ref, str):
            sink_class = getattr(import_module("pipelinekit.destinations"), sink_class_ref)
