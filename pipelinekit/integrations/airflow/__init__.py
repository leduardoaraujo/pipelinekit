"""Airflow integration for PipelineKit.

This module provides operators, hooks, and sensors for running PipelineKit
pipelines within Apache Airflow DAGs.

Example:
    from pipelinekit.integrations.airflow import ForgeFlowOperator
